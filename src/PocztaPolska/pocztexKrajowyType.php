...
class pocztexKrajowyType extends \PocztaPolska\przesylkaRejestrowanaType {
	...
	/** @var \PocztaPolska\doreczenieType */	public $doreczenie;
	/** @var \PocztaPolska\zwrotDokumentowType */	public $zwrotDokumentow;
	/** @var \PocztaPolska\potwierdzenieOdbioruType */	public $potwierdzenieOdbioru;
	...
	/** @var \PocztaPolska\terminRodzajType */	public $terminRodzaj;
	/** @var boolean */	public $kopertaFirmowa;
