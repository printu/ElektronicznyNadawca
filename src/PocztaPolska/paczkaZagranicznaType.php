...
class paczkaZagranicznaType extends \PocztaPolska\przesylkaRejestrowanaType {
	/** @var \PocztaPolska\zwrotType */	public $zwrot;
	/** @var \PocztaPolska\deklaracjaCelnaType */	public $deklaracjaCelna;
	...
	/** @var boolean */	public $utrudnionaManipulacja;
	/** @var boolean */	public $ekspres;
	/** @var string */	public $numerReferencyjnyCelny;
}
