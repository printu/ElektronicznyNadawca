...
class uslugaKurierskaType extends \PocztaPolska\przesylkaRejestrowanaType {
	...
	/** @var \PocztaPolska\odbiorPrzesylkiOdNadawcyType */	public $odbiorPrzesylkiOdNadawcy;
	...
	/** @var \PocztaPolska\subUslugaKurierskaType */	public $subPrzesylka;
	/** @var \PocztaPolska\potwierdzenieOdbioruKurierskaType */	public $potwierdzenieOdbioru;
	/** @var \PocztaPolska\ubezpieczenieType */	public $ubezpieczenie;
	/** @var \PocztaPolska\zwrotDokumentowKurierskaType */	public $zwrotDokumentow;
	/** @var \PocztaPolska\doreczenieUslugaKurierskaType */	public $doreczenie;
