...
class PotwierdzenieOdbioruPaczkowaType extends AbstractStructBase
{
     ...
     * Set ilosc value
     * @param int $ilosc
     * @return \PocztaPolska\StructType\PotwierdzenieOdbioruPaczkowaType
     */
    ...
    /**
     * Set sposob value
     * @uses \PocztaPolska\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztowaType::valueIsValid()
     * @uses \PocztaPolska\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztowaType::getValidValues()
    ...
    public function setSposob(?string $sposob = null): self
    {
        ...
        if (!\PocztaPolska\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztowaType::valueIsValid($sposob)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \PocztaPolska\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztowaType', is_array($sposob) ? implode(', ', $sposob) : var_export($sposob, true), implode(', ', \PocztaPolska\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztowaType::getValidValues())), __LINE__);
        }
        $this->sposob = $sposob;
