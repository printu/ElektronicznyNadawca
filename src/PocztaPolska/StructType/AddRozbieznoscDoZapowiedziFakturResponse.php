...
class AddRozbieznoscDoZapowiedziFakturResponse extends AbstractStructBase
{
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $addRozbieznoscDoZapowiedziFakturResponseErrorItem) {
            ...
            if (!$addRozbieznoscDoZapowiedziFakturResponseErrorItem instanceof \PocztaPolska\StructType\ErrorType) {
     ...
     * @param \PocztaPolska\StructType\ErrorType[] $error
     * @return \PocztaPolska\StructType\AddRozbieznoscDoZapowiedziFakturResponse
     */
