...
class CreateReturnDocumentsProfileResponse extends AbstractStructBase
{
     ...
     * Set result value
     * @param bool $result
     * @return \PocztaPolska\StructType\CreateReturnDocumentsProfileResponse
     */
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $createReturnDocumentsProfileResponseErrorItem) {
            ...
            if (!$createReturnDocumentsProfileResponseErrorItem instanceof \PocztaPolska\StructType\ErrorType) {
