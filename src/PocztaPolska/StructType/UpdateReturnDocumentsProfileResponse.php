...
class UpdateReturnDocumentsProfileResponse extends AbstractStructBase
{
     ...
     * Set result value
     * @param bool $result
     * @return \PocztaPolska\StructType\UpdateReturnDocumentsProfileResponse
     */
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $updateReturnDocumentsProfileResponseErrorItem) {
            ...
            if (!$updateReturnDocumentsProfileResponseErrorItem instanceof \PocztaPolska\StructType\ErrorType) {
