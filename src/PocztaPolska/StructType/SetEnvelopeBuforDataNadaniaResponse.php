...
class SetEnvelopeBuforDataNadaniaResponse extends AbstractStructBase
{
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $setEnvelopeBuforDataNadaniaResponseErrorItem) {
            ...
            if (!$setEnvelopeBuforDataNadaniaResponseErrorItem instanceof \PocztaPolska\StructType\ErrorType) {
     ...
     * @param \PocztaPolska\StructType\ErrorType[] $error
     * @return \PocztaPolska\StructType\SetEnvelopeBuforDataNadaniaResponse
     */
