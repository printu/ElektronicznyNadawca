...
class AddZalacznikDoReklamacjiResponse extends AbstractStructBase
{
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $addZalacznikDoReklamacjiResponseErrorItem) {
            ...
            if (!$addZalacznikDoReklamacjiResponseErrorItem instanceof \PocztaPolska\StructType\ErrorType) {
     ...
     * @param \PocztaPolska\StructType\ErrorType[] $error
     * @return \PocztaPolska\StructType\AddZalacznikDoReklamacjiResponse
     */
